      ...
      <div className="max-w-7xl mx-auto  px-5 xl:px-0">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <Card className="h-full flex flex-col border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <div className={`p-3 rounded-lg w-fit mb-4 ${service.color} bg-opacity-10`}>
                    {service.icon}
                  </div>
